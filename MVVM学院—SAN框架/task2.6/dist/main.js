...
/***/ "./node_modules/css-loader/index.js?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san ***!
  \*********************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.task-menu {\n    width: 250px;\n    border: 1px solid #C6BEB3;\n    border-radius: 5px;\n    background: #FCF1E3;\n    padding: 10px;\n    margin: 20px;\n}\n.task-menu-body {\n    padding: 15px;\n    border: 1.5px solid rgb(255, 201, 139) \n}\n.taskTitle {\n    max-width: 70%;\n    margin: 0 auto;\n    padding: 5px 10px;\n    font-size: 18px;\n    color: #DE302D;\n    text-align: center;\n    font-weight: lighter;\n    /* border: 1px solid #F2BA21; */\n    border-radius: 5px;\n    background-image: linear-gradient(to bottom, #F7CF10, #F2BA21);\n}\n.paster {\n    width: 70%;\n    padding: 20px;\n    margin: 30px auto;\n    margin-bottom: 0;\n    background: #FFEBA7;\n}\n.paster p {\n    margin: 0;\n}\n.paster-title {\n    margin: 0;\n    margin-bottom: 10px;\n    font-size: 16px;\n    font-weight: lighter;\n}\n\n", "", {"version":3,"sources":["/home/code/Desktop/ife/MVVM学院—SAN框架/task2.6/src/view/task-menu.san?c60a9ae6"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA+BA;IACA,aAAA;IACA,0BAAA;IACA,mBAAA;IACA,oBAAA;IACA,cAAA;IACA,aAAA;CACA;AACA;IACA,cAAA;IACA,sCAAA;CACA;AACA;IACA,eAAA;IACA,eAAA;IACA,kBAAA;IACA,gBAAA;IACA,eAAA;IACA,mBAAA;IACA,qBAAA;IACA,gCAAA;IACA,mBAAA;IACA,+DAAA;CACA;AACA;IACA,WAAA;IACA,cAAA;IACA,kBAAA;IACA,iBAAA;IACA,oBAAA;CACA;AACA;IACA,UAAA;CACA;AACA;IACA,UAAA;IACA,oBAAA;IACA,gBAAA;IACA,qBAAA;CACA","file":"task-menu.san","sourcesContent":["<template>\n    <template>\n        <div class=\"task-menu\" s-for=\"item,index in datasource\" >\n            <div class=\"task-menu-body\">\n                <h2 class=\"taskTitle\">\n                    <slot name=\"taskTitle\">{{ taskTitle + (index + 1) }}</slot>\n                </h2>\n                <div class=\"paster\">\n                    <h2 class=\"paster-title\"><slot name=\"paster-title-name\">标题</slot>:<slot name=\"title\" var-title=\"item.title\">{{ title }}</slot></h2>\n                    <p s-for=\"menu in item.datasource\" class=\"paster-{{ menu.type }}\" ><slot name=\"paster-{{ menu.type }}-name\" var-menu=\"menu\">{{ menu.name }}</slot>：<slot name=\"{{ menu.type }}\" var-menu=\"menu\">{{ menu.content }}</slot></p>\n                </div>\n            </div>\n        </div>\n    </template>\n</template>\n\n<script>\n    export default {\n        initData: function () {\n            return {\n                taskTitle: \"任务\"\n            }\n        },\n        inited: function() {\n            console.log(this.data.get(\"datasource\"));\n            \n        }\n    }\n</script>\n\n<style>\n    .task-menu {\n        width: 250px;\n        border: 1px solid #C6BEB3;\n        border-radius: 5px;\n        background: #FCF1E3;\n        padding: 10px;\n        margin: 20px;\n    }\n    .task-menu-body {\n        padding: 15px;\n        border: 1.5px solid rgb(255, 201, 139) \n    }\n    .taskTitle {\n        max-width: 70%;\n        margin: 0 auto;\n        padding: 5px 10px;\n        font-size: 18px;\n        color: #DE302D;\n        text-align: center;\n        font-weight: lighter;\n        /* border: 1px solid #F2BA21; */\n        border-radius: 5px;\n        background-image: linear-gradient(to bottom, #F7CF10, #F2BA21);\n    }\n    .paster {\n        width: 70%;\n        padding: 20px;\n        margin: 30px auto;\n        margin-bottom: 0;\n        background: #FFEBA7;\n    }\n    .paster p {\n        margin: 0;\n    }\n    .paster-title {\n        margin: 0;\n        margin-bottom: 10px;\n        font-size: 16px;\n        font-weight: lighter;\n    }\n\n</style>"],"sourceRoot":""}]);
...
/***/ "./node_modules/html-loader/index.js?minimize=false!./node_modules/san-loader/lib/selector.js?type=template&index=0!./src/view/task-menu.san":
/*!******************************************************************************************************************************************!*\
  !*** ./node_modules/html-loader?minimize=false!./node_modules/san-loader/lib/selector.js?type=template&index=0!./src/view/task-menu.san ***!
  \******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* harmony import */ var _task_menu_san__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./task-menu.san */ "./src/view/task-menu.san");
/* harmony import */ var _task_menu_san__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_task_menu_san__WEBPACK_IMPORTED_MODULE_0__);
// <template>
//     <template>
//         <h1>任务栏</h1>
//         <task-menu class="task-menu-content" datasource="{{ list }}" title="未定义的标题">
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        "task-menu": _task_menu_san__WEBPACK_IMPORTED_MODULE_0___default.a
    },
    initData: function () {
        return {
            // title: "aaa",
...
/***/ "./node_modules/san-loader/lib/selector.js?type=script&index=0!./src/view/task-menu.san":
/*!**********************************************************************************************!*\
  !*** ./node_modules/san-loader/lib/selector.js?type=script&index=0!./src/view/task-menu.san ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san ***!
  \*************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../node_modules/css-loader?sourceMap!../../node_modules/san-loader/lib/style-rewriter.js!../../node_modules/san-loader/lib/selector.js?type=style&index=0!./task-menu.san */ "./node_modules/css-loader/index.js?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san");
...
var __san_script__, __san_template__
var __san_styles__ = {}
__webpack_require__(/*! !style-loader!css-loader?sourceMap!../../node_modules/san-loader/lib/style-rewriter.js!../../node_modules/san-loader/lib/selector.js?type=style&index=0!./task-menu.san */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?sourceMap!./node_modules/san-loader/lib/style-rewriter.js!./node_modules/san-loader/lib/selector.js?type=style&index=0!./src/view/task-menu.san")
__san_script__ = __webpack_require__(/*! !!../../node_modules/san-loader/lib/selector.js?type=script&index=0!./task-menu.san */ "./node_modules/san-loader/lib/selector.js?type=script&index=0!./src/view/task-menu.san")
if (__san_script__ &&
    __san_script__.__esModule &&
    Object.keys(__san_script__).length > 1) {
  console.warn("[san-loader] src/view/task-menu.san: named exports in *.san files are ignored.")}
__san_template__ = __webpack_require__(/*! !html-loader?minimize=false!../../node_modules/san-loader/lib/selector.js?type=template&index=0!./task-menu.san */ "./node_modules/html-loader/index.js?minimize=false!./node_modules/san-loader/lib/selector.js?type=template&index=0!./src/view/task-menu.san")
var __san_proto__ = {}
if (__san_script__) {
  __san_proto__ = __san_script__.__esModule
    ? __san_script__['default']
