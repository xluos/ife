...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.enter,\n.leave {\n    transition: all .5s;\n}\n\n.before-enter,\n.leave {\n    opacity: 0;\n}\n\n.enter,\n.before-leave {\n    opacity: 1;\n}\n", "", {"version":3,"sources":["/home/code/Desktop/ife/MVVM学院—SAN框架/task2.7.1/src/view/s-transition.san?7a66ebe8"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA+FA;;IAEA,oBAAA;CACA;;AAEA;;IAEA,WAAA;CACA;;AAEA;;IAEA,WAAA;CACA","file":"s-transition.san","sourcesContent":["<template>\n    <div>\n        <button on-click=\"toggle\">TOGGLE</button>\n        <span s-if=\"show\" s-transition=\"hook\">\n            Transition Layer\n        </span>\n    </div>\n</template>\n\n<script>\n    export default {\n        initData() {\n            return { show: true };\n        },\n        toggle() {\n            this.data.set(\"show\", !this.data.get('show'));\n        },\n        hook: {/* your answer */\n\n            // // 第一次的实现方式\n            // enter: function (el, done) {\n            //     // console.log('enter');\n            //     el.classList.add(\"before-enter\");\n            //     setTimeout(()=>{\n            //         el.classList.add(\"enter\");\n            //         done();\n            //     },0)\n            // },\n            // leave: function (el, done) {\n            //     // console.log('leave');\n            //     el.className = \"\";\n            //     el.classList.add(\"before-leave\");\n            //     el.className = \"\";\n            //     el.classList.add(\"leave\");\n            //     console.log(done);\n            //     setTimeout(()=>{\n            //         done();\n            //     },500)\n            // }\n\n            //第二次参考san-transition后的实现\n\n            enter(el, done) {\n                el.classList.add(\"before-enter\");\n                setTimeout(() => {\n                    el.classList.remove(\"before-enter\");\n                    el.classList.add(\"enter\");\n                    setTimeout(() => {\n                        el.classList.remove(\"enter\");\n                        done();\n                    }, 500);\n                }, 0);\n            },\n            leave(el, done) {\n                el.classList.add(\"before-leave\");\n                setTimeout(() => {\n                    el.classList.remove(\"before-leave\");\n                    el.classList.add(\"leave\");\n                    setTimeout(done, 500);\n                }, 0);\n            }\n            // //其他人的实现方式\n            // enter(el, done) {\n            //     const listener = () => {\n            //         el.classList.remove('before-enter', 'enter');\n            //         el.removeEventListener('transitionend', listener);\n            //         done();\n            //     }\n            //     el.addEventListener(\"transitionend\", listener);\n\n            //     el.classList.add('before-enter');\n            //     setTimeout(() => {\n            //         el.classList.add('enter');\n            //     }, 0);\n            // },\n\n            // leave(el, done) {\n            //     const listener = () => {\n            //         el.classList.remove('leave');\n            //         el.removeEventListener('transitionend', listener);\n            //         done();\n            //     }\n            //     el.addEventListener('transitionend', listener);\n            //     // el.classList.add('before-leave');\n            //     setTimeout(() => {\n            //         // el.classList.remove('before-leave');\n            //         el.classList.add('leave');\n            //     }, 0);\n\n            // }\n        }\n    }\n</script>\n\n<style>\n    .enter,\n    .leave {\n        transition: all .5s;\n    }\n\n    .before-enter,\n    .leave {\n        opacity: 0;\n    }\n\n    .enter,\n    .before-leave {\n        opacity: 1;\n    }\n</style>"],"sourceRoot":""}]);
