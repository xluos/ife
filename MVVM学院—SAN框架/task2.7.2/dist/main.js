...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.slide-before-leave,\n.slide-before-enter {\n    opacity: 0;\n}\n\n/* 进入动画 */\n@keyframes bounceInRight {\n    from,\n    60%,\n    75%,\n    90%,\n    to {\n      -webkit-animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n      animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n    }\n  \n    from {\n      opacity: 0;\n      -webkit-transform: translate3d(3000px, 0, 0);\n      transform: translate3d(3000px, 0, 0);\n    }\n  \n    60% {\n      opacity: 1;\n      -webkit-transform: translate3d(-25px, 0, 0);\n      transform: translate3d(-25px, 0, 0);\n    }\n  \n    75% {\n      -webkit-transform: translate3d(10px, 0, 0);\n      transform: translate3d(10px, 0, 0);\n    }\n  \n    90% {\n      -webkit-transform: translate3d(-5px, 0, 0);\n      transform: translate3d(-5px, 0, 0);\n    }\n  \n    to {\n      -webkit-transform: translate3d(0, 0, 0);\n      transform: translate3d(0, 0, 0);\n    }\n  }\n  .slide-enter {\n    -webkit-animation-duration: 1s;\n    animation-duration: 1s;\n    -webkit-animation-name: bounceInRight;\n    animation-name: bounceInRight;\n  }\n  /* 删除动画 */\n  @keyframes hinge {\n    0% {\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n    }\n  \n    20%,\n    60% {\n      -webkit-transform: rotate3d(0, 0, 1, 80deg);\n      transform: rotate3d(0, 0, 1, 80deg);\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n    }\n  \n    40%,\n    80% {\n      -webkit-transform: rotate3d(0, 0, 1, 60deg);\n      transform: rotate3d(0, 0, 1, 60deg);\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n      opacity: 1;\n    }\n  \n    to {\n      -webkit-transform: translate3d(0, 700px, 0);\n      transform: translate3d(0, 700px, 0);\n      opacity: 0;\n    }\n  }\n  \n  .slide-leave {\n    -webkit-animation-duration: 2s;\n    animation-duration: 2s;\n    -webkit-animation-name: hinge;\n    animation-name: hinge;\n  }\n", "", {"version":3,"sources":["/home/code/Desktop/ife/MVVM学院—SAN框架/task2.7.2/src/view/App.san?ea03f9ae"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAgCA;;IAEA,WAAA;CACA;;AAEA,UAAA;AACA;IACA;;;;;MAKA,uEAAA;MACA,+DAAA;KACA;;IAEA;MACA,WAAA;MACA,6CAAA;MACA,qCAAA;KACA;;IAEA;MACA,WAAA;MACA,4CAAA;MACA,oCAAA;KACA;;IAEA;MACA,2CAAA;MACA,mCAAA;KACA;;IAEA;MACA,2CAAA;MACA,mCAAA;KACA;;IAEA;MACA,wCAAA;MACA,gCAAA;KACA;GACA;EACA;IACA,+BAAA;IACA,uBAAA;IACA,sCAAA;IACA,8BAAA;GACA;EACA,UAAA;EACA;IACA;MACA,mCAAA;MACA,2BAAA;MACA,+CAAA;MACA,uCAAA;KACA;;IAEA;;MAEA,4CAAA;MACA,oCAAA;MACA,mCAAA;MACA,2BAAA;MACA,+CAAA;MACA,uCAAA;KACA;;IAEA;;MAEA,4CAAA;MACA,oCAAA;MACA,mCAAA;MACA,2BAAA;MACA,+CAAA;MACA,uCAAA;MACA,WAAA;KACA;;IAEA;MACA,4CAAA;MACA,oCAAA;MACA,WAAA;KACA;GACA;;EAEA;IACA,+BAAA;IACA,uBAAA;IACA,8BAAA;IACA,sBAAA;GACA","file":"App.san","sourcesContent":["<template>\n    <template>\n        <button on-click=\"add\">添加</button>\n        <button on-click=\"remove\">删除</button>\n        <ul>\n            <li s-for=\"item in list\" s-transition=\"hook('slide', 300)\">列出具有过渡效果的元素 {{item}}.</li>\n        </ul>\n    </template>\n</template>\n\n<script>\n    import { transition } from 'san-transition';\n    export default {\n        initData: function () {\n            return {\n                index: 6,\n                list: [1, 2, 3, 4, 5]\n            }\n        },\n        hook: transition,\n        add: function () {\n            this.data.push(\"list\", this.data.get(\"index\"));\n            this.data.set(\"index\", this.data.get(\"index\") + 1);\n        },\n        remove: function () {\n            this.data.pop(\"list\");\n            this.data.set(\"index\", this.data.get(\"index\") - 1);\n        }\n    }\n</script>\n\n<style>\n.slide-before-leave,\n.slide-before-enter {\n    opacity: 0;\n}\n\n/* 进入动画 */\n@keyframes bounceInRight {\n    from,\n    60%,\n    75%,\n    90%,\n    to {\n      -webkit-animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n      animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n    }\n  \n    from {\n      opacity: 0;\n      -webkit-transform: translate3d(3000px, 0, 0);\n      transform: translate3d(3000px, 0, 0);\n    }\n  \n    60% {\n      opacity: 1;\n      -webkit-transform: translate3d(-25px, 0, 0);\n      transform: translate3d(-25px, 0, 0);\n    }\n  \n    75% {\n      -webkit-transform: translate3d(10px, 0, 0);\n      transform: translate3d(10px, 0, 0);\n    }\n  \n    90% {\n      -webkit-transform: translate3d(-5px, 0, 0);\n      transform: translate3d(-5px, 0, 0);\n    }\n  \n    to {\n      -webkit-transform: translate3d(0, 0, 0);\n      transform: translate3d(0, 0, 0);\n    }\n  }\n  .slide-enter {\n    -webkit-animation-duration: 1s;\n    animation-duration: 1s;\n    -webkit-animation-name: bounceInRight;\n    animation-name: bounceInRight;\n  }\n  /* 删除动画 */\n  @keyframes hinge {\n    0% {\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n    }\n  \n    20%,\n    60% {\n      -webkit-transform: rotate3d(0, 0, 1, 80deg);\n      transform: rotate3d(0, 0, 1, 80deg);\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n    }\n  \n    40%,\n    80% {\n      -webkit-transform: rotate3d(0, 0, 1, 60deg);\n      transform: rotate3d(0, 0, 1, 60deg);\n      -webkit-transform-origin: top left;\n      transform-origin: top left;\n      -webkit-animation-timing-function: ease-in-out;\n      animation-timing-function: ease-in-out;\n      opacity: 1;\n    }\n  \n    to {\n      -webkit-transform: translate3d(0, 700px, 0);\n      transform: translate3d(0, 700px, 0);\n      opacity: 0;\n    }\n  }\n  \n  .slide-leave {\n    -webkit-animation-duration: 2s;\n    animation-duration: 2s;\n    -webkit-animation-name: hinge;\n    animation-name: hinge;\n  }\n</style>"],"sourceRoot":""}]);
